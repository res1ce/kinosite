...
import { MapPin, Search, Filter, Grid, List, Star, Camera, Mountain, Building } from "lucide-react";
...
const mockLocations = [
  {
    ...
    description: 'Живописные горные пейзажи идеально подходят для съемок драматических сцен и документальных фильмов о природе.',
    ...
    features: ['Панорамные виды', 'Дикая природа', 'Горные тропы'],
    galleryUrls: [
  ...
  },
  {
    ...
    description: 'Архитектурный комплекс с богатой историей, отлично подходит для исторических драм и современных фильмов.',
    address: 'г. Чита, центральная часть',
    latitude: 52.034,
    longitude: 113.499,
    ...
    features: ['Историческая архитектура', 'Центральная площадь', 'Памятники'],
    galleryUrls: [
      'https://images.unsplash.com/photo-1521737711867-e3b97375f902?w=400&q=80',
      'https://images.unsplash.com/photo-1520637836862-4d197d17c93a?w=400&q=80'
    ]
  },
  {
    id: '3',
    name: 'Байкальские степи',
    description: 'Бескрайние степные просторы создают уникальную атмосферу для съемок вестернов и приключенческих фильмов.',
    address: 'Забайкальский край, степная зона',
    latitude: 51.8,
    longitude: 113.8,
    category: 'Природа',
    rating: 4.8,
    popularity: 78,
    coverImage: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&q=80',
    features: ['Открытые пространства', 'Закаты', 'Дикие животные'],
    galleryUrls: [
      'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400&q=80',
  ...
  {
    id: '4',
    name: 'Киностудия Забайкалье',
    description: 'Современная киностудия с профессиональным оборудованием и павильонами для съемок любой сложности.',
    address: 'г. Чита, ул. Кинематографистов, 15',
    latitude: 52.05,
    longitude: 113.52,
    category: 'Студии',
    rating: 4.9,
    ...
    features: ['Павильоны', 'Техника', 'Звукозапись'],
    galleryUrls: [
  ...
  },
  {
    id: '5',
    name: 'Озеро Арахлей',
    description: 'Кристально чистое озеро в окружении лесов - идеальное место для романтических сцен и пейзажных съемок.',
    address: 'Читинский район, с. Арахлей',
    latitude: 52.2,
    longitude: 113.2,
    category: 'Природа',
    rating: 4.6,
    ...
    features: ['Водная гладь', 'Леса', 'Отражения'],
    galleryUrls: [
      'https://images.unsplash.com/photo-1439066615861-d1af74d74000?w=400&q=80',
      'https://images.unsplash.com/photo-1418489098061-ce87b5dc3aee?w=400&q=80'
    ]
  }
];
...
export default function LocationsPage() {
  ...
  const [mapCenter, setMapCenter] = useState([52.034, 113.499]);
  ...
  const filteredLocations = locations.filter(location => {
    ...
    const matchesCategory = selectedCategory === 'Все' || location.category === selectedCategory;
                      ...
                      <div className="absolute top-full right-0 mt-2 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden animate-scaleIn z-20">
                        {categories.map((category) => (
                          <button
                            ...
                            className={`flex items-center gap-3 w-full text-left px-6 py-3 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors ${
                              selectedCategory === category ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300' : ''
                            }`}
                          >
