...
const mockNews = [
  {
    ...
    coverImageUrl: 'https://images.unsplash.com/photo-1489599500846-a62a3c6b0ff3?w=800&q=80',
    category: 'Фестивали'
  },
  {
    id: '2',
    slug: 'new-location-discovered',
    title: 'Открыта новая киноплощадка в горах',
    shortDescription: 'Потрясающие виды Забайкальских гор станут декорацией для новых фильмов.',
  ...
  {
    id: '3',
    slug: 'cooperation-agreement',
    title: 'Подписано соглашение о сотрудничестве',
    shortDescription: 'Новые возможности для съемочных групп и инвесторов в регионе.',
  ...
  },
  {
    ...
    title: 'Премьера документального фильма',
    shortDescription: 'Уникальный взгляд на природу и культуру Забайкальского края.',
    date: new Date('2024-08-28'),
    coverImageUrl: 'https://images.unsplash.com/photo-1440404653325-ab127d49abc1?w=800&q=80',
    category: 'Премьеры'
  },
  {
    id: '5',
    slug: 'young-filmmakers-contest',
    title: 'Конкурс молодых кинематографистов',
    shortDescription: 'Поддержка талантливой молодежи и развитие кинокультуры в регионе.',
    date: new Date('2024-08-20'),
    coverImageUrl: 'https://images.unsplash.com/photo-1485846234645-a62644f84728?w=800&q=80',
    category: 'Конкурсы'
  }
];
