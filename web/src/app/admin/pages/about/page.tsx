            ...
            <form action={addTeamMember} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={3}
                  placeholder="Основатель кинокомиссии, продюсер более 80 проектов"
                  className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-900/50 focus:outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/20 transition-all duration-200 resize-none"
                />
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-4">
                {teamMembers.map((member, index) => (
                  <div key={member.id} className="group p-6 bg-gray-50/50 dark:bg-gray-900/20 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 transition-all duration-200">
                      ...
                      <div className="flex-shrink-0 flex items-start gap-2">
                        ...
                        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                          <button
                            type="button"
                            onClick={() => {
                              const editForm = document.getElementById(`edit-form-${member.id}`);
                              if (editForm) {
                    ...
                    {/* Edit Form */}
                    <div id={`edit-form-${member.id}`} className="hidden mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
