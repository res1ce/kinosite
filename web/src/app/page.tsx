...
const mockSite = {
  heroText: "Организуем съёмки, подбираем локации и сопровождаем проекты в регионе.",
  feature1Number: "250+",
  feature1Label: "Локаций в каталоге",
  feature2Number: "50+",
  feature2Label: "Партнёрских проектов",
  feature3Number: "15 лет",
  feature3Label: "поддержки киноиндустрии",
      ...
      <div className="relative container mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-white/70 max-w-2xl mx-auto animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
            Полный спектр услуг для развития киноиндустрии в Забайкальском крае
          </p>
        </div>
